...
const CARD_ICONS = [ShieldCheck, Sparkles, InfinityIcon];
      ...
      <div className="container relative">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-editorial text-4xl md:text-6xl leading-tight tracking-tight mb-6">
            {g.titleLead} <em className="text-gradient-gold not-italic font-editorial italic">{g.titleEm}</em>
          </h2>
        ...
        <div className="max-w-3xl mx-auto mb-12">
          <div className="border border-accent/30 rounded-sm p-10 md:p-14 text-center bg-primary-foreground/[0.03] backdrop-blur-sm relative">
            ...
            <p className="font-display text-lg text-accent mb-3" dir="rtl">{g.brandAr}</p>
          ...
          {g.cards.map((card, i) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-editorial text-2xl text-primary-foreground mb-2">{card.t}</h3>
                <p className="text-sm text-primary-foreground/65 leading-relaxed font-body">{card.d}</p>
              </Card>
            );
          })}
        </div>
