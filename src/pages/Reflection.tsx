...
const ReflectionPage = () => {
  ...
  const handleSubmit = async () => {
    if (body.trim().length < 10) {
      toast.error("اكتب تأمّلًا صادقًا (10 أحرف على الأقل)");
      return;
    }
    if (!verseId) {
    ...
    try {
      ...
      toast.success("تم حفظ التأمّل");
      navigate("/progress");
    } catch (e: any) {
      toast.error(e?.message ?? "تعذّر حفظ التأمّل");
    }
  };
        ...
        <section className="container max-w-3xl py-16 md:py-20">
          ...
          <div className="card-elevated rounded-xl p-8 space-y-6">
            <div className="space-y-2">
              <Label htmlFor="reflection-body">تأمّلك</Label>
              <Textarea
                id="reflection-body"
                value={body}
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              ...
              >
                {createReflection.isPending ? "جارٍ الحفظ..." : "احفظ التأمّل"}
              </Button>
